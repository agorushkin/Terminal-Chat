...
import {
  ...
  handleMouseControls,
} from 'tui/src/controls.ts';

import { Box } from 'tui/src/components/box.ts';
import { Text } from 'tui/src/components/text.ts';
import { Frame } from 'tui/src/components/frame.ts';
import { Input } from 'tui/src/components/input.ts';
import { Label } from 'tui/src/components/label.ts';
import { Table } from 'tui/src/components/table.ts';
import { Button } from 'tui/src/components/button.ts';
import { Slider } from 'tui/src/components/slider.ts';
import { CheckBox } from 'tui/src/components/checkbox.ts';
import { ComboBox } from 'tui/src/components/combobox.ts';
import { ProgressBar } from 'tui/src/components/progressbar.ts';

import { Theme } from 'tui/src/theme.ts';
import { View } from 'tui/src/view.ts';
import { Component, Rectangle } from 'tui/mod.ts';
import { TextBox } from 'tui/src/components/textbox.ts';
